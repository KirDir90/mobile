...
#define USE_SYSTEM_DIRENT
#endif

#ifdef USE_SYSTEM_DIRENT
#include <dirent.h>
#include <sys/stat.h>
#include <unistd.h>

/* Use system dirent functions */
#define opendir_raylib opendir
#define readdir_raylib readdir
#define closedir_raylib closedir

/* Simple wrapper structure */
struct DIR {
    DIR* dirp;
};
#else
/* Original Windows code here... */
#endif
